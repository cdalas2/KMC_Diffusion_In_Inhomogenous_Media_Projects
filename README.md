...
It is also interesting that this simple model which could be characterized by a different diffusion rate in the nanodomain suggests that protein clustering emerges from a change in diffusion rates in part of the domain as a consequence of not being able to move as quickly.
