...
> We applied kinetic monte carlo (KMC) methods, for predicting the trajectories of freely diffusing particles in various heterogeneous media [1,2], to investigate several scenarios in biophysics. This video is of a bacteria simulated to diffuse in a porous media with pores of characteristic size 3.6 &mu;m, using measurements from [4]. This video is of a 10-minute simulated sped up by about 20x.
